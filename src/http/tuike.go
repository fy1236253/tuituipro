					...
					case "component_verify_ticket":
						{
							...
							open.SetInRedisTicket(ComponentVerifyTicket)
						}
					//授权
					case "authorized":
						{
							authorInfo := util.GetAuthorizationInfo(mixedMsg.AuthorizationCode)
							util.CheckIsNil(authorInfo)
							authorInfo.AuthorizationInfo.SetBasicAuthorizerInfo()
							util.SetOpenLocation(mixedMsg.AuthorizerAppid)
					...
					case "unauthorized":
						{
							...
							util.DelAuthorInfo(mixedMsg.AuthorizerAppid)
