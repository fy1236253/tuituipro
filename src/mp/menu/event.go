...
func GetClickEvent(msg *message.MixedMessage) *ClickEvent {
	return &ClickEvent{
...
// 判断是否是内部命令
func (self *ClickEvent) IsInnerEvent() bool {
	if self.EventKey[0:6] == "inner_" {
		return true
	}
	return false
}
...
func GetViewEvent(msg *message.MixedMessage) *ViewEvent {
	return &ViewEvent{
		MessageHeader: msg.MessageHeader,
		Event:         msg.Event,
		EventKey:      msg.EventKey,
...
func GetScanCodePushEvent(msg *message.MixedMessage) *ScanCodePushEvent {
...
func GetScanCodeWaitMsgEvent(msg *message.MixedMessage) *ScanCodeWaitMsgEvent {
...
func GetPicSysPhotoEvent(msg *message.MixedMessage) *PicSysPhotoEvent {
...
func GetPicPhotoOrAlbumEvent(msg *message.MixedMessage) *PicPhotoOrAlbumEvent {
...
func GetPicWeixinEvent(msg *message.MixedMessage) *PicWeixinEvent {
...
func GetLocationSelectEvent(msg *message.MixedMessage) *LocationSelectEvent {
